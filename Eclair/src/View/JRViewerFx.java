...
import Controller.JRViewerFxController;
...
public class JRViewerFx extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            //fxmlStream = getClass().getResourceAsStream("/View/FRViewerFx.fxml");
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/FRViewerFx.fxml"));
